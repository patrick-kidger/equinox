...
def _assert_jaxpr_equal(jaxpr1: jax.extend.core.ClosedJaxpr, jaxpr2: jax.extend.core.ClosedJaxpr):
...
def test_fn2fn_custom_idempotent():
    ...
    finalised_finalised_jaxpr = cast(jax.extend.core.ClosedJaxpr, finalised_finalised_jaxpr)
